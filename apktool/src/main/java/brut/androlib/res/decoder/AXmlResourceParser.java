...
public class AXmlResourceParser implements XmlResourceParser {
    ...
    public int getIdAttributeResourceValue(int defaultValue) {
        ...
        if (valueType != TypedValues.TYPE_REFERENCE) {
            return defaultValue;
        }
    ...
    public String getAttributeValue(int index) {
        ...
        return TypedValues.coerceToString(valueType, valueData);
    }
    ...
    public float getAttributeFloatValue(int index, float defaultValue) {
        int offset = getAttributeOffset(index);
        int valueType = m_attributes[offset + ATTRIBUTE_IX_VALUE_TYPE];
        if (valueType == TypedValues.TYPE_FLOAT) {
            int valueData = m_attributes[offset + ATTRIBUTE_IX_VALUE_DATA];
    ...
    public int getAttributeIntValue(int index, int defaultValue) {
        int offset = getAttributeOffset(index);
        int valueType = m_attributes[offset + ATTRIBUTE_IX_VALUE_TYPE];
        if (valueType >= TypedValues.TYPE_FIRST_INT && valueType <= TypedValues.TYPE_LAST_INT) {
            return m_attributes[offset + ATTRIBUTE_IX_VALUE_DATA];
        }
        return defaultValue;
    }
